...
if st.session_state.current != None:
    ...
    if st.session_state.current == "T":
        ...
        if A:
            st.write("My Guess is: **Jerusalem**.")
            st.markdown('<a href="/Round_14" target="_self">Next Round</a>', unsafe_allow_html=True)
