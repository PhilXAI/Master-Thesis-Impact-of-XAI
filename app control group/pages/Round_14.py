...
if st.session_state.current != None:
    ...
    if st.session_state.current == "T":
        ...
        if A:
            st.write("My Guess is: **Berlin**.")
            st.markdown('<a href="/Round_15" target="_self">Next Round</a>', unsafe_allow_html=True)
